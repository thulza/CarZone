// Comprehensive Car Database - 10+ Brands, 20+ Cars Each
// Part 1: Mercedes-AMG (25 cars)
const mercedesAMGCars = [
  {
    id: 1,
  ...
  },
  {
    ...
    year: 2019,
    description: "The AMG GT 63 S combines the soul of a sports car with the practicality of a four-door. Its twin-turbo V8 delivers exceptional performance while maintaining luxury.",
    specs: {
  ...
  },
  {
    ...
    category: "Performance Sedan",
    year: 2021,
    description: "The E63 S combines executive luxury with track-ready performance. Its handcrafted 4.0L V8 biturbo engine delivers devastating acceleration.",
    specs: {
      engine: "4.0L Twin-Turbo V8",
      horsepower: "603 HP",
      torque: "627 lb-ft",
...
const bmwMCars = [
  ...
  },
  {
    ...
    category: "Performance Sedan",
    year: 2021,
    description: "The M5 Competition represents the pinnacle of BMW's performance sedan engineering. With its twin-turbo V8 and xDrive all-wheel drive, it delivers blistering acceleration.",
    specs: {
...
const audiSportCars = [
  {
    ...
    year: 2020,
    description: "The RS Q8 redefines what a performance SUV can be. With its twin-turbo V8 and quattro all-wheel drive, it delivers supercar-level acceleration in a practical SUV package.",
    specs: {
      engine: "4.0L Twin-Turbo V8",
      horsepower: "591 HP",
      torque: "590 lb-ft",
  ...
  },
  {
    ...
    year: 2020,
    description: "The RS6 Avant proves that practicality doesn't have to come at the cost of performance. This stunning wagon combines supercar-level acceleration with genuine everyday usability.",
    specs: {
      engine: "4.0L Twin-Turbo V8",
      horsepower: "591 HP",
      torque: "590 lb-ft",
